...
public class PlacarArmazenamento {
	...
	public void pontosPorUsuario() {
		...
		assertTrue(
				resultado.stream().anyMatch(ponto -> ponto.getTipo().equals("moeda") && ponto.getQuantidade() == 20));
		assertTrue(
				resultado.stream().anyMatch(ponto -> ponto.getTipo().equals("estrela") && ponto.getQuantidade() == 10));
	}
