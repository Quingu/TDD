...
public class ArmazenamentoTeste<usuarioRepositorio, usuarioRepositorio1> {
	...
	public void recuperarPontosPorUsuarioETipo() {
		...
		armazenamento.armazenarPontuacao("peach", "estrela", 20);
	...
	public void recuperarUsuariosComPontos() {
		...
		armazenamento.armazenarPontuacao("peach", "moeda", 0);
